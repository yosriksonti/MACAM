    ...
    ?>
        ...
        <div class="container" id="wrapper">
            <?php
                ...
                $Salon=new SalonC();
                $data= $Salon->GetSalon($_GET['ID']);
                foreach($data as $row)
                {
                    $Exp=new ExpoC();
                    $Data=$Exp->GetExpo($row['ID_Expo']);
                    foreach($Data as $rw)
                    echo'
                                                    ...
                                                    <div class="journal-content-article">
                                                        <div class="web-content">
                                                            <div class="web-content-text">
                                                                ...
                                                                <div class="rubric-page-name"> <strong>Dans: </strong> <a href="Exposition.php?ID='.$rw['ID'].'"> '.$rw['Nom'].' </a></div>
...
-->
                                                        ...
                                                        <div class="rubric-page">
                                                            <div class="rubric-page-image">
                                                                <a href="Oeuvre.php?ID='.$row['ID'].'">
                                                                    <img src="Admin/'.$row['Image'].'" /> </a>
                                                            </div>
                                                            <div class="rubric-page-name"> <a href="Oeuvre.php?ID='.$row['ID'].'"> '.$row['Nom'].' </a> </div>
                                                            <div class="rubric-page-description">
                                                                
                                                            </div>
                                                            <div class="rubric-page-read-more"> <a href="Oeuvre.php?ID='.$row['ID'].'"> En savoir plus </a> </div>
                                                        </div>';
                                                        ?>
...
-->
                                                        ...
                                                        $Data=$Salon->GetArtists($_GET['ID']);
                                                        foreach($Data as $rw)
                                                        {
                                                            $Art=new ArtistC();
                                                            $data=$Art->GetArtist($rw['ID_Art']);
                                                            foreach($data as $row)
                                                            echo'
                                                        ...
                                                        <div class="rubric-page">
                                                            <div class="rubric-page-image">
                                                                <a href="Artiste.php?ID='.$row['ID'].'">
                                                                    <img src="Admin/'.$row['Image'].'" /> </a>
                                                            </div>
                                                            <div class="rubric-page-name"> <a href="Artiste.php?ID='.$row['ID'].'"> '.$row['Nom'].' </a> </div>
                                                            <div class="rubric-page-description">
                                                                
                                                            </div>
                                                            <div class="rubric-page-read-more"> <a href="Artiste.php?ID='.$row['ID'].'"> En savoir plus </a> </div>
                                                        </div>';
                                                        }
                                                        ?>
