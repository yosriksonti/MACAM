...
$ID=$_GET['ID'];
$Salon=new SalonC();
$data1=$Salon->GetSalon($ID);
$Ouv=new OeuvreC();
$data2=$Ouv->GetBySalon($ID);
$Exp=new ExpoC();
          ...
          <div class="animated fadeIn">
            ...
            <div class="card">
                  ...
                  <div class="jumbotron">
                      ...
                      <hr class="my-4">';
                      $data3=$Exp->GetExpo($row['ID_Expo']);
                       foreach($data3 as $r)
                        echo'
                      <p>Exposition: <a href="Expo.php?ID='.$r['ID'].'">'.$r['Nom'].'</a></p>';
                      echo'
              ...
              <div class="col-lg-12">
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <form action="Add_Oeuvre.php" method="POST">
                      <input type="hidden" name="ID" value="<?php echo $row['ID']; ?>">
                      <button type="submit" class="btn btn-block btn-primary">Add Oeuvre</button>
                     </form>

                     </br>
                     </br>
                     <form action="DELSalon.php" method="POST">
                      <input type="hidden" name="ID" value="<?php echo $row['ID']; }?>">
