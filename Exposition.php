                                                            ...
                                                            <div class="page-header-info">
                                                                <div class="page-header-title-and-share">
                                                                    <div class="page-header-title">
                                                                        <h1>'.$row['Nom'].' </br><strong style="font-size: 80%;">'.$row['Date_d'].' | '.$row['Date_f'].'</strong></h1></div>
...
-->
                                                        ...
                                                        <div class="rubric-page">
                                                            <div class="rubric-page-image">
                                                                <a href="Salon.php?ID='.$row['ID'].'">
                                                                    <img src="Admin/'.$row['Image'].'" /> </a>
                                                            </div>
                                                            <div class="rubric-page-name"> <a href="Salon.php?ID='.$row['ID'].'"> '.$row['Nom'].' </a> </div>
                                                            <div class="rubric-page-description">
                                                                
                                                            </div>
                                                            <div class="rubric-page-read-more"> <a href="Salon.php?ID='.$row['ID'].'"> En savoir plus </a> </div>
                                                        </div>';
                                                        ?>
