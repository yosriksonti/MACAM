...
(function ($) { 
    if($('.museum-dates-list').length){

        var lessHeight, moreHeight;
        var $dates_list = $('.museum-dates-list'),
            $dates_toggle = $('.museum-see-dates');
        ...
        function moreDates(moreHeight){
            $dates_toggle.find('.museum-less').show();
            $dates_toggle.find('.museum-more').hide();
            $dates_list.height(moreHeight);
        }

        function lessDates(lessHeight){
            $dates_toggle.find('.museum-less').hide();
            $dates_toggle.find('.museum-more').show();
